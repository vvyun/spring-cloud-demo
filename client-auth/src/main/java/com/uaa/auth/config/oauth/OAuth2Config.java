    ...
    public ClientDetailsService myClientDetailsService() {
        return new ClientDetailsService() {
            ...
            public ClientDetails loadClientByClientId(String clientId) throws ClientRegistrationException {
                ...
                MClientDetail ClientDetail = clientSecretService.getClientDetailsByClientId(clientId);

                BaseClientDetails details = new BaseClientDetails(ClientDetail.getClientId(),
                        ClientDetail.getResourceIds(),
                        ClientDetail.getScopes(),
                        ClientDetail.getGrantTypes(),
                        ClientDetail.getAuthorities(),
                        ClientDetail.getRedirectUris());
